...
| --- | --- | --- | --- | --- |
| 09-07 | Remove the agent-ready automation; development is manual from here on | — | #61 | [`5307875`](https://github.com/artisam-centient/centient/commit/5307875c71b04bc5b38aa60fbb6dfb31b7c2518a) |
| 09-07 | Re-provision the testnet multisig proof on an operable account | #5 | #62 | [`c8eded2`](https://github.com/artisam-centient/centient/commit/c8eded2179a52aeeb5e1e2b589bf94c94aed491f) |
| 09-07 | Prove a multisig USDC fee-bump payout end to end | #6 | #64 | [`dca64c6`](https://github.com/artisam-centient/centient/commit/dca64c6a0cb9ca2257197f160225305d47bf4560) |
| 09-07 | Multisig cold-reserve refills | #10 | #65 | [`7b9d2eb`](https://github.com/artisam-centient/centient/commit/7b9d2ebacc291f8dbb79ad273fa5d4f7b85ecb17) |
| 09-07 | Multisig payout service with sequence-safe submission | #7 | #66 | [`8ad80c3`](https://github.com/artisam-centient/centient/commit/8ad80c328685be0abc4d2b6b930c8e582b08eb2c) |
| 09-07 | Close the ambiguous-submit window | #7 | #69 | [`3bc6920`](https://github.com/artisam-centient/centient/commit/3bc6920e44879ce47f243c5f768024d8b1c40ef5) |
| 09-07 | Resolve an ambiguous submit only on proof, and never refund one | #7 | #70 | [`5f4b58c`](https://github.com/artisam-centient/centient/commit/5f4b58c4d0ca9491b7b4d2f3248f09378cc6ddfe) |
| 09-08 | Dual-asset (USDC + XLM) wallet-health monitoring | #11 | #72 | [`6fee0a9`](https://github.com/artisam-centient/centient/commit/6fee0a972f844c7f403698f4b8f4cf2f830aae1d) |
| 09-08 | Close the submission double-pay window and spec-review gaps | #73 | #74 | [`b96c89d`](https://github.com/artisam-centient/centient/commit/b96c89d5ae07ae919709d85236b1b972588d134e) |
| 09-08 | Independent policy co-signer that re-derives payouts from the task ledger | #8 | #75 | [`2bdd6a0`](https://github.com/artisam-centient/centient/commit/2bdd6a0c4b77b933b6fdcfa97ab29f7dd7da2939) |
| 09-08 | ADR-0001: simulated co-signer isolation | #8 | #71 | [`7efc104`](https://github.com/artisam-centient/centient/commit/7efc104bda28bd7bdfac4974a78bf6ff67a5e380) |
| 09-08 | Co-signer adapted to the same-project topology, with a setup wizard | #8 | #76 | [`85b0fb2`](https://github.com/artisam-centient/centient/commit/85b0fb2c24971cbe70d05a72ffd897a0d0a48824) |
| 09-08 | Enforce independent daily payout caps at both signers | #9 | #78 | [`3862ac3`](https://github.com/artisam-centient/centient/commit/3862ac37bb8dbfeebdc6fa2460bb8546b0ff83b4) |
| 09-08 | Payments-lane proof: no single-key path, zero double-pays, named CI lane | #12 | #79 | [`7437678`](https://github.com/artisam-centient/centient/commit/743767823156a5dbe434b376a0a8beb9c2726634) |
| 09-08 | CI: exempt merge commits from the commit-identity rule | — | #83 | [`3fd157f`](https://github.com/artisam-centient/centient/commit/3fd157fd995e70e7d2468465b16b7c6e46aff69d) |
| 09-09 | QA fixtures, reset path, CI at the deployed SHA | #86 | #88 | [`0187170`](https://github.com/artisam-centient/centient/commit/0187170a02376062185e872d11775d5da5961f4c) |
| 09-09 | Refresh the Deliverable 1 QA readiness guide | #13 | #89 | [`650c624`](https://github.com/artisam-centient/centient/commit/650c62435b193e0a6ad3f6e72a9f34dd6fc40bb0) |
| 09-09 | **Promote `develop` → `staging`**: Deliverable 1 payout rail | — | #84 | [`6ea51e0`](https://github.com/artisam-centient/centient/commit/6ea51e0ef6f3dd467b7eebf34bf80fdf67fff921) |
| 09-11 | **Enforce deployment-level signer custody** (F-01 fix) | #80 | #93 | [`8067123`](https://github.com/artisam-centient/centient/commit/80671230d95891d1bb5a22536298bf3303c2d5e4) |
| 09-11 | Promote to `staging`: F-01 custody fix. **This is the SHA QA passed** | — | #94 | [`263be4c`](https://github.com/artisam-centient/centient/commit/263be4cd5ab06103d965044c6a8bd3c40678f308) |
| 09-11 | Restate the deployed reserve policy as 20/24/5 after the TC-021 refill | — | #95 | [`a1137f9`](https://github.com/artisam-centient/centient/commit/a1137f977713b02b907e16f267da76bebfbf3349) |
| 09-14 | **Promote `staging` → `main`**: Deliverable 1 | — | #92 | — |

## Decisions

**The co-signer runs in its own Railway project, not a separate account (8 Sep).** The plan asked for a separate company-owned Railway account for the co-signer. That approval would have blocked Week 1 on billing and ownership paperwork for a rail with nothing of value on it, so it was withdrawn for the MVP. The co-signer has its own container, service-scoped variables, deploy trigger and member list. It uses HMAC-authenticated transport and a read-only database role for re-deriving from the ledger, and the app refuses to boot if it can see both the co-signer URL and the policy secret. **What this does not buy:** one Railway account, one repository, one CI and one database instance. The limit is machine-checked: `COSIGNER_ISOLATION_LEVEL=same-workspace` refuses to sign when `STELLAR_NETWORK=public`. → [ADR-0001](https://github.com/artisam-centient/centient/blob/develop/docs/adr/0001-simulated-cosigner-isolation.md)

**Seeded QA credentials accepted on testnet (9 Sep).** The shared QA logins were left as they were for the internal testnet pass. They are recorded as an accepted risk with explicit exit criteria. → [ADR-0002](https://github.com/artisam-centient/centient/blob/develop/docs/adr/0002-seeded-credentials-accepted-on-testnet-qa.md)

**A cap-alert ordering defect is fixed inside #12, not deferred (8 Sep).** The success-path cap alert used to fire before the payout was persisted, so it could read a stale total and miss a threshold crossing. It now runs at the three sites that persist the payout, each right after that write succeeds. An ordering-controlled test covers it. → [payments-lane evidence](https://github.com/artisam-centient/centient/blob/develop/docs/payments-lane-evidence.md)
...
* Runbooks: [multisig](https://github.com/artisam-centient/centient/blob/develop/docs/stellar-multisig-runbook.md), [daily cap](https://github.com/artisam-centient/centient/blob/develop/docs/stellar-daily-payout-cap-runbook.md), [cold reserve](https://github.com/artisam-centient/centient/blob/develop/docs/stellar-cold-reserve-runbook.md), [payout failure](https://github.com/artisam-centient/centient/blob/develop/docs/stellar-payout-failure-runbook.md)
...
* The separate Railway account for the co-signer is now a **mainnet-readiness** item. *(Since 25 Sep the sprint is testnet only, D-7.)* → [Open risks](../reference/risks.md)
